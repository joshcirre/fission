    ...
    <flux:card>
        <form wire:submit="login" class="space-y-6">
            ...
            <div class="space-y-6">
                ...
                <flux:field>
                    <flux:label class="flex w-full justify-between">
                        ...
                        <flux:link href="{{ route('password.request') }}" wire:navigate variant="subtle">Forgot password?</flux:link>
                    </flux:label>
            ...
            <div class="space-y-2">
                ...
                <flux:button variant="ghost" class="w-full" href="{{ route('register') }}" wire:navigate>Sign up for a new account</flux:button>
            </div>
        </form>
    </flux:card>
</div>
